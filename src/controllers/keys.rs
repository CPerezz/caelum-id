 ...
 */
pub fn add_key(_key: Key, _gas_price: &U256, from: &Address, contract: &web3::contract::Contract<web3::transports::Http>) -> Option<(Key,H256)> {
 ...
 */
pub fn remove_key(_key: Key, _gas_price: &U256, from: &Address, contract: &web3::contract::Contract<web3::transports::Http>) -> Option<H256> {
 ...
 */
pub fn get_keys_by_purpose(from: &Address, purpose: &U256, contract: &web3::contract::Contract<web3::transports::Http>) -> Option<Vec<H256>> {
 ...
 * @return The key.
 */
pub fn get_key(from: &Address, decoded_key: H256, contract: &web3::contract::Contract<web3::transports::Http>) -> Option<Key> {
 ...
 */
pub fn key_has_purpose(from: &Address, decoded_key: H256, contract: &web3::contract::Contract<web3::transports::Http>) -> bool {
